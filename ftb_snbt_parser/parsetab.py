...
_lr_goto_items = {'snbt':([0,],[1,]),'compound':([0,12,13,24,26,31,],[2,16,16,16,16,16,]),'key_value_pairs':([3,],[4,]),'key_value_pair':([3,4,11,],[6,10,14,]),'value':([12,13,24,26,31,],[15,25,28,30,32,]),'array':([12,13,24,26,31,],[17,17,17,17,17,]),'values':([24,],[26,]),}
...
_lr_productions = [
  ...
  ('snbt -> compound','snbt',1,'p_snbt','snbt_yacc.py',6),
  ('compound -> LBRACE key_value_pairs RBRACE','compound',3,'p_compound','snbt_yacc.py',10),
  ('compound -> LBRACE RBRACE','compound',2,'p_compound','snbt_yacc.py',11),
  ('key_value_pairs -> key_value_pairs key_value_pair','key_value_pairs',2,'p_key_value_pairs','snbt_yacc.py',18),
  ('key_value_pairs -> key_value_pairs COMMA key_value_pair','key_value_pairs',3,'p_key_value_pairs','snbt_yacc.py',19),
  ('key_value_pairs -> key_value_pair','key_value_pairs',1,'p_key_value_pairs','snbt_yacc.py',20),
  ('key_value_pair -> NAME COLON value','key_value_pair',3,'p_key_value_pair','snbt_yacc.py',29),
  ('key_value_pair -> STRING COLON value','key_value_pair',3,'p_key_value_pair','snbt_yacc.py',30),
  ('value -> compound','value',1,'p_value','snbt_yacc.py',34),
  ('value -> array','value',1,'p_value','snbt_yacc.py',35),
  ('value -> BOOL','value',1,'p_value','snbt_yacc.py',36),
  ('value -> BYTE','value',1,'p_value','snbt_yacc.py',37),
  ('value -> DOUBLE','value',1,'p_value','snbt_yacc.py',38),
  ('value -> LONG','value',1,'p_value','snbt_yacc.py',39),
  ('value -> INTEGER','value',1,'p_value','snbt_yacc.py',40),
  ('value -> STRING','value',1,'p_value','snbt_yacc.py',41),
  ('array -> LBRACKET values RBRACKET','array',3,'p_array','snbt_yacc.py',45),
  ('array -> LBRACKET RBRACKET','array',2,'p_array','snbt_yacc.py',46),
  ('values -> values value','values',2,'p_values','snbt_yacc.py',53),
  ('values -> values COMMA value','values',3,'p_values','snbt_yacc.py',54),
  ('values -> value','values',1,'p_values','snbt_yacc.py',55),
]
